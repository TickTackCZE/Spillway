...
- `/Users/ondrej/Documents/VaultHub/3. Areas/Programování/Standardy/PR — Programovací principy.md`
- `/Users/ondrej/Documents/VaultHub/3. Areas/Programování/Standardy/SEC — Bezpečnost.md`

PR odkazuje dál na soubor pro tenhle konkrétní stack (`MAC — macOS nativní
aplikace.md`) a na UI komponenty (`UI — Komponenty a vzhled.md`) — přečti si
i ten, než děláš cokoli s UI v nastavovacím okně (WKWebView). SEC čti vždycky
celé, ne jen proletět — platí bez výjimky.
