...
| **Blokery** | **18 nových bugů z code review (B4–B21, §6)** — B4/B5 kritické, doporučeno opravit před `.app`; GUI test klávesy/AI profilu/detekce prohlížeče |
...
**Zdroj B4–B21:** code review agentem **Fable 5** (15. 7. 2026) — dostal celý plán + všech 19 zdrojových souborů, hledal race conditions, resource leaky a porušení invariantů B1/O6/R4. Nálezy B4, B5, B9 jsem přímo ověřil čtením kódu (sedí přesně na uvedené řádky); zbytek neověřován zvlášť, ale u ověřených byl report přesný, takže zbytku důvěřuju s běžnou obezřetností. **Zatím jen zalogováno, nic neopraveno.** Doporučená priorita před zabalením do `.app`: **B4 a B5 první** (obě dokážou appku reálně rozbít — potlačené psaní písmene / zdvojená instance), pak **B6/B7/B9/B10** (souvisí se stabilitou hotkey a vlákna tapu), zbytek (B11–B21) může počkat na F4/polish.
